"""
Django settings for almost_fs project.
...
SECRET_KEY = 'django-insecure-h+ni31muo*t)#-%tzgor#hy930i$=ean277hi3k8axckweven3'
...
WSGI_APPLICATION = 'almost_fs.wsgi.application'
ASGI_APPLICATION = 'almost_fs.asgi.application'
