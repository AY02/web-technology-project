...
**Note:** Before program execution, use the personalized command `resetdb` to instantiate the example data:  
`python3 manage.py resetdb && python3 manage.py runserver`
